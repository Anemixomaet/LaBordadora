...
class RolSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create(['name' => 'jugadores.nuevo'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'jugadores.editar'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'jugadores.eliminar'])->syncRoles([$role1, $role2]);

        Permission::create(['name' => 'temporadas'])->syncRoles([$role1]);
        ...
        Permission::create(['name' => 'inscripciones.nuevo'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'inscripciones.editar'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'inscripciones.eliminar'])->syncRoles([$role1, $role2]);

        Permission::create(['name' => 'asistencia'])->syncRoles([$role1, $role2]);;
        Permission::create(['name' => 'asistencia.nuevo'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'asistencia.editar'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'asistencia.eliminar'])->syncRoles([$role1, $role2]);

        Permission::create(['name' => 'pagos'])->syncRoles([$role1, $role2]);;
        Permission::create(['name' => 'pagos.nuevo'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'pagos.editar'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'pagos.eliminar'])->syncRoles([$role1, $role2]);

        Permission::create(['name' => 'reportes.jugadores_categoria'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'reportes.jugadores_asistencia'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'reportes.jugadores_pago'])->syncRoles([$role1, $role2]);

        Permission::create(['name' => 'notificaciones'])->syncRoles([$role1, $role2]);
    }
}
