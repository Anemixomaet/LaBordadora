                ...
                <div class="border-gray-900/10 pb-12">
                    <div class="mt-10 grid grid-cols-4 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <div class="sm:col-span-2">
                            ...
                            <div class="px-3">
                                <input type="date" wire:model="fecha" name="fecha" id="fecha" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            </div>
                        </div>
                        <div class="sm:col-span-2">
                            ...
                            <div class="px-3">
                                ...
                                <select name="categoria" wire:model="categoria" 
                                    ...
                                    @foreach($categorias as $categori)
                                        <option value="{{ $categori->id }}">{{ $categori->detalle }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
